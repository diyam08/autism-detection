...
st.set_page_config(page_title="ASD Screening Tool (ISAA Based)", layout="centered")

st.title(" Autism Screening Tool (ISAA-Based Prototype)")
st.write("**Educational Project – Not a medical diagnosis tool**")
